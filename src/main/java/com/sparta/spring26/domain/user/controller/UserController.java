...
public class UserController {
     ...
     */
    @GetMapping("/me")
    public ResponseEntity<ApiResponse<?>> getUserInfo(@AuthenticationPrincipal UserDetailsImpl userDetails){
        return ResponseEntity.ok(ApiResponse.success(userService.getUserInfo(userDetails.getUser().getId())));
    }
}